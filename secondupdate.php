...
if (isset($_POST['updatesecondyear'])) {
    // $id = $_POST['id'];
    $name = $_POST['name'];
    $phone = $_POST['phone'];
    $email = $_POST['email'];
    ...
    $update_query = "UPDATE user SET level = 'past' WHERE id = ?";
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <textarea name="description" rows="5" style="width: 100%; height:100%;" placeholder="Student Description" value="<?php echo "{$info['description']}"; ?>"></textarea>
                <br>
            </div>
        </div>
        <div class="row">
    ...
    <div class="row">
    <br>
        <button type="submit" class="btn btn-info" name="updatesecondyear">Update</button>
    </div>
</form>
