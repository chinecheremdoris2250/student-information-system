...
<?php
include 'db.php';
$sql = "SELECT * FROM user WHERE level = '200' ORDER BY school ASC";
...
<h2 class="text-center">VIEW STUDENTS</h2>
    ...
    <table class="table table-bordered">
        ...
        ?>
            <tbody class="tbody tbody-striped tbody-dark">
                <tr>
                    <td class="table_td">
                    ...
                    <td class="table_td"><?php echo "<a class='btn btn-primary' href='secondupdate.php?student_id={$info['id']}'> Update </a>" ?></td>
                    <td class="table_td"><?php echo"<a class='btn btn-info' href='seconview.php?id={$info['id']}'> View </a>" ?></td>
                </tr>
            </tbody>
        <?php
        }
