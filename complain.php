...
$query = "INSERT INTO complaints (username, email, complaint) VALUES (?, ?, ?)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Bind the parameters
    mysqli_stmt_bind_param($statement, "sss", $username, $email, $complaint);
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="username" placeholder="Usernamer" name="username" required>
            <br>  
        </div>
        <div class="form-group col-md-6">
<br>
